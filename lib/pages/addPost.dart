...
class AddPostState extends State<AddPost> {
  var roll =
      FirebaseAuth.instance.currentUser!.email!.substring(0, 8).toUpperCase();
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          padding: EdgeInsets.symmetric(
              vertical: mq.height * 0.03, horizontal: mq.width * 0.05),
          child: Column(
            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    height: MediaQuery.of(context).size.width *
                        ((pickedImage.path != "") ? 0.9 : 0.5),
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(12),
                        image: DecorationImage(
                          image: (pickedImage.path != "")
                              ? Image.file(pickedImage).image
                              : Image.asset('assets/images/imgbg.png').image,
                        )),
                  ),
                  if (pickedImage.path == "")
                    Positioned(
              ...
              TextField(
                ...
                decoration: InputDecoration.collapsed(
                    hintText: "Something about your post ..."),
                onChanged: (value) {
              ...
              Center(
                child: ElevatedButton(
                  ...
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(
                        (isPosting == true) ? Colors.black54 : Colors.black),
