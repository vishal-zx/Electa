  ...
  _loadPicker() async {
    if (_rollPresent == true) {
      ...
      if (permissionStatus.isGranted) {
        ...
        error =
            makeBar('Permission not granted. Try Again with permission access');
        ScaffoldMessenger.of(context).showSnackBar(error);
      }
    } else {
    ...
    if (_checkRoll == true) {
      try {
        QuerySnapshot qs = await FirebaseFirestore.instance
            .collection('users')
            .where('Roll', isEqualTo: email.substring(0, 8).toUpperCase())
            .get();
        var cans = qs.docs;
        var fl = 0;
        for (var can in cans) {
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            return BackdropFilter(
              ...
              child: new AlertDialog(
                  ...
                  backgroundColor: Colors.blueGrey[100],
                  title: Text(
                    "Select the role you want to continue as:",
                    textAlign: TextAlign.center,
                  ),
                  actions: <Widget>[
                    Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () {
                              CollectionReference u = FirebaseFirestore.instance
                          ...
                          if (loading == false) {
                            ...
                            if (roll != "" && name != "") {
                              if (_validRoll == "true") {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(makeBar(
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                  makeBar("Name/Roll number missing !!"));
                            }
                          }
                        },
