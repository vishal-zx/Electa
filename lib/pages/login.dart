                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Material(
                            color:
                                (_check1 == true) ? Colors.grey : Colors.black,
                            borderRadius:
                                BorderRadius.circular(_check ? 50 : 8),
                            child: InkWell(
                              onTap: () async {
                                check(context);
                                if (_check1 == true) {
                                    ...
                                    return AlertDialog(
                                      ...
                                      content: SingleChildScrollView(
                                        child: ListBody(
                                          children: <Widget>[
                                            Text(
                                                'Enter your Roll Number to reset the password.'),
                                            SizedBox(
                                              height: 15,
                                            ),
                                            Form(
                                                    ...
                                                    return AlertDialog(
                                                      ...
                                                      content:
                                                        ...
                                                        child: ListBody(
                                                          children: <Widget>[
                                                            Text(
                                                                'If entered Roll Number matches an existing account, Password reset mail sent to associated email address.'),
                                                          ],
                                                        ),
                                                      ),
                                                      actions: <Widget>[
